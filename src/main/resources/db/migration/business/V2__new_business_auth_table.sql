...
-- ----------------------------
-- Table structure for application_data
-- ----------------------------
...
-- ----------------------------
-- Table structure for hashed_data
-- ----------------------------
CREATE TABLE hashed_data (
id serial8 NOT NULL,
hash varchar(350) COLLATE pg_catalog.default NOT NULL
);
...
ALTER TABLE hashed_data ADD CONSTRAINT hashed_data_hash_uidx UNIQUE (hash) WITH (fillfactor=100);
